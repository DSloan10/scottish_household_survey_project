...
all_la_percents %>% 
  select(c(date_code, local_authority, less_than_11_mins, an_11_minute_walk_or_more, a_5_minute_walk_or_less, within_a_6_10_minute_walk, dont_know)) %>% 
...
gb_long_pivot_back %>% 
  select(c(date_code, local_authority, type, class, less_than_11_mins, an_11_minute_walk_or_more, a_5_minute_walk_or_less, within_a_6_10_minute_walk, dont_know)) %>% 
  rename(year = date_code) %>% 
